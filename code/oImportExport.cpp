...
bool oEvent::exportOECSV(const wchar_t *file, const set<int>& classes, int languageTypeIndex, bool includeSplits, bool byClass)
{
  enum {
  ...
  if (byClass) {
    ...
    calculateResults(classes, ResultType::CourseResult);
